...
float interact = 1.0-mouseEffect(uv, mouse, 0.380);//加上interact讓滑鼠碰到圓圈可以互動
...
{
//float index=0.0;
// float noise_position= smoothstep(-0.2, 0., -uv.y+-0.036); //option1
float noise_position= interact+dir; //option2 //加上dir代表沒有互動的時候圓圈也會自己動
